...
angular.module("com.2fdevs.videogular")
    ...
    ['$scope', '$window', 'vgConfigLoader', 'vgFullscreen', 'VG_UTILS', 'VG_STATES', 'VG_VOLUME_KEY', 'communicator', function ($scope, $window, vgConfigLoader, vgFullscreen, VG_UTILS, VG_STATES, VG_VOLUME_KEY, communicator) {
        ...
        this.seekTime = function (value, byPercent) {
            ...
            communicator.emitActionMessage({
                previousTime: this.currentTime / 1000,
                currentTime: second,
                playbackRate: this.playback,
                paused: this.currentState !== "play",
                types: "seeked"
            });
